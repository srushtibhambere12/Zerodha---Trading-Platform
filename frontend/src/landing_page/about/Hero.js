...
function Hero() {
  return (
    <div className="container about">
      ...
      <div className="row p-5 mt-5 border-top text-muted" style={{lineHeight: "1.8"}}>
        ...
        <div className="col-lg-6 col-md-6 col-sm-12 p-4 about-content">
            ...
            <p><a href="">Rainmatter</a>, our 
                fintech fund and incubator, has invested in several
            ...
            <p>And yet, we are always up to something new every day. Catch up on the
                latest updates on our <a href="">blog</a> 
                or see what the media is <a href="">saying about us</a>.
            </p>
        </div>
      </div>
    </div>
